...
const Profile = ({ onNavigate }) => {
  ...
  const fetchProfileData = async () => {
    try {
      ...
      console.log('Fetching profile from: http://localhost:3000/profile');
      ...
      console.log('Fetching watchlist from: http://localhost:3000/profile/watchlist');
      ...
      console.log('Fetching reviews from: http://localhost:3000/profile/reviews');
